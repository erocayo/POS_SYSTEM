...
Route::middleware(['sessionAuth', 'role:1'])->group(function () {
    // USER
...
Route::middleware(['sessionAuth', 'role:2'])->group(function () {
// SALE TRANSACTION
...
Route::middleware(['sessionAuth', 'role:3'])->group(function () {
//PRODUCTS
