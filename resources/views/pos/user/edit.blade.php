...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" style="background: linear-gradient(to right,  #FF3F3F, #FF4500 , #FF7F50, #FFA500, #FFD700);">
        <div class="container-fluid">
            ...
            <div class="d-flex">
                <a href="{{ url('/pos/user') }}" class="btn btn-light text-primary me-2">User List</a>
    ...
    <div class="center-content">
        <div class="form-box">
            ...
            <div class="text-center mt-3">
                <a href="{{ url('/pos/user') }}" class="btn btn-secondary w-100">Go Back</a>
            </div>
        </div>
    </div>


    <!-- ADMIN VALIDATION SCRIPT (kept from your original code) -->
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function checkAdminRequirement() {
                // Prevent selecting themself as admin
